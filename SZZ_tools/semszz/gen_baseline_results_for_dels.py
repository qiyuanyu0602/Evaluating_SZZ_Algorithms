...
sys.path.append(
    ".DelBaselines/ICSE2022ReplicationPackage/icse2021-szz-replication-package/tools/pyszz"
)
...
rszz = RSZZ(repo_full_name="linux", repo_url=None, repos_dir=REPOS_DIR)
lszz = LSZZ(repo_full_name="linux", repo_url=None, repos_dir=REPOS_DIR)
...
cnt = 0
data_to_check = []
with open("./dataset/dataset_d.json") as f:
...
for cid_info in data_to_check:
    ...
    try:
        ...
        b_impact_files = baseszz.get_impacted_files(
        ...
        with open("baseline_results_for_del.txt", "w") as f:
